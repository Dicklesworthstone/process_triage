...
// Sections 9-19: GPU detection is Linux-only (pt_core::collect::gpu).
#[cfg(target_os = "linux")]
mod gpu {
    use super::*;
    use pt_core::collect::gpu::{
        parse_nvidia_device_csv, parse_nvidia_process_csv, parse_rocm_json,
        parse_rocm_process_json, parse_rocm_text, GpuDetectionSource, GpuDevice, GpuProvenance,
